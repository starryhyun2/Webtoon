...
<body>
<h4>안녕하세요. ${sessionScope.id } 님</h4>
	<!-- if 문을 위해 var에 check_login 값 설정 -->
	<c:set var="var" value="${ check_login }" />
	<h1 id="main_title">
		<a href='mainToon.do'>
		<img src="/webtoon/resources/thumbnail/korea_logo.jpg" style="width:60px;"/>
		<span>코리아 웹툰</span>
		</a>
	</h1>
	<div id="header">
	...
	<!-- 상단 네비게이션 -->
	<nav class="nav_bar">
		<span class="nav_list">홈</span>
		<span class="nav_list">오늘의 웹툰</span>
...
<div class="slide-background">
	...
	<div style="width:100%;" align="middle" >
		...
		<div style="width:100%; height:500px; position:absolute;"></div>
			<iframe id="youtube_link" src="https://www.youtube.com/embed/gnH65r0A2fg?start=77&autoplay=1&mute=1&loop=1&controls=0" title="YouTube video player"
			 frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="margin-top:-5%; margin-bottom:-5%;"></iframe>
		</div>
	</div>
